...
def build(
    ...
    - 15.2.0: Latest GCC 15, glibc 2.39, newest features
    - 14.3.0: Latest GCC 14, glibc 2.39, modern features
    - 13.4.0 (default): Latest GCC 13, glibc 2.39, Ubuntu 24.04 compatible
    - 12.5.0: Latest GCC 12, glibc 2.35, Ubuntu 22.04 compatible
    - 11.5.0: Latest GCC 11, glibc 2.35, good compatibility
    - 10.5.0: GCC 10, glibc 2.31, RHEL 8/Ubuntu 20.04 compatible
    - 9.5.0: Latest GCC 9, glibc 2.28, wide compatibility
    - 8.5.0: GCC 8, glibc 2.28, RHEL 8 minimum
    - 7.5.0: GCC 7, glibc 2.17, RHEL 7 compatible (maximum compatibility)
    ...
    Examples:
        ...
        slurm-factory build --compiler-version 15.2.0         # Build with latest gcc 15
        slurm-factory build --compiler-version 14.3.0         # Build with latest gcc 14
