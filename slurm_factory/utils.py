...
def create_slurm_package(
    ...
    logger.debug(
        ...
        f"enable_hierarchy={enable_hierarchy}"
    )
...
def publish_compiler_to_buildcache(
    ...
    try:
        ...
        cmd.extend([
            ...
            f"spack buildcache push --unsigned --update-index --without-build-dependencies s3-buildcache gcc-runtime@{compiler_version}"
        ])
