...
def generate_compiler_bootstrap_config(
    ...
    Args:
        gcc_version: GCC version to build (e.g., "11.4.0", "10.5.0", "8.5.0")
...
def generate_spack_config(
    ...
    Args:
        ...
        use_spack_compiler: If True, use Spack-built compiler from /opt/spack-compiler
    ...
    # Determine compiler spec based on whether we're using Spack-built compiler
    if use_spack_compiler:
        compiler_spec = f"%gcc@{compiler_version}"
    else:
        compiler_spec = "%gcc@13.3.0"  # Use system compiler
    ...
    config: Dict[str, Any] = {
        "spack": {
            ...
            "concretizer": {
                ...
                "reuse": use_spack_compiler,  # Reuse compiler if using Spack-built compiler
            },
                    ...
                    "externals": [
                        {
                            ...
                            "prefix": "/opt/spack-compiler" if use_spack_compiler else "/usr",
                            "extra_attributes": {
                                "compilers": {
...
def generate_yaml_string(
    ...
    Args:
        ...
        compiler_version: GCC compiler version to use
        use_spack_compiler: Whether to use a Spack-built compiler instead of system compiler
...
if __name__ == "__main__":
    ...
    print(
        generate_yaml_string(
            "25.05", compiler_version="10.5.0", use_spack_compiler=True, gpu_support=False, minimal=False
        )
    )
