...
from slurm_factory.utilities import (
...
class TestGetMkdirCommands:
    ...
    def test_get_mkdir_commands_basic(self):
        ...
        expected_lines = ["mkdir -p /opt/test/dir1", "mkdir -p /opt/test/dir2", "mkdir -p /opt/test/dir3"]
        assert result == "\n".join(expected_lines)
...
class TestTemplates:
    ...
    def test_cache_setup_script_template(self):
        ...
        result = CACHE_SETUP_SCRIPT.substitute(
            create_cache_dirs="mkdir -p /test/dir1\nmkdir -p /test/dir2", cache_dir="/test/cache"
        )
    ...
    def test_patch_copy_script_template(self):
        ...
        result = PATCH_COPY_SCRIPT.substitute(
            patches_dir="/opt/patches", patch_name="test.patch", patch_content="diff content here"
        )
    ...
    def test_spack_project_setup_script_template(self):
        ...
        result = SPACK_PROJECT_SETUP_SCRIPT.substitute(
            project_dir="/root/spack-project", spack_config="spack:\n  specs: [slurm]"
        )
    ...
    def test_spack_install_script_template(self):
        ...
        result = SPACK_INSTALL_SCRIPT.substitute(
            project_dir="/root/spack-project", spack_setup="/opt/spack/share/spack/setup-env.sh"
        )
    ...
    def test_copy_output_script_template(self):
        ...
        result = COPY_OUTPUT_SCRIPT.substitute(
            slurm_dir="/opt/slurm", version="25.05", output_dir="/opt/output"
        )
...
class TestStringTemplateIntegration:
    ...
    def test_template_with_container_paths(self):
        ...
        result = test_template.substitute(cache_dir=CONTAINER_CACHE_DIR, patches_dir=CONTAINER_PATCHES_DIR)
    ...
    def test_mkdir_commands_with_cache_setup(self):
        ...
        result = CACHE_SETUP_SCRIPT.substitute(create_cache_dirs=mkdir_commands, cache_dir="/opt/test")
