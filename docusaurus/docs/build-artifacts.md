...
```text
s3://slurm-factory-spack-buildcache-4b670/compilers/{toolchain}/buildcache/
...
```text
s3://slurm-factory-spack-buildcache-4b670/slurm/{slurm_version}/{toolchain}/buildcache/
├── build_cache/                   # Compiled binary packages
│   ├── linux-ubuntu24.04-x86_64_v3/
│   │   ├── gcc-13.4.0/
...
├── compilers/{toolchain}/buildcache/
└── slurm/{slurm_version}/{toolchain}/buildcache/
```
...
| centos7 | CentOS 7 / RHEL 7 | `https://vantage-public-assets.s3.amazonaws.com/slurm-factory/25.11/centos7/slurm-25.11-centos7-software.tar.gz` |
